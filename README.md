...
Код обработки [roi_cutting_for_ocr.py](src/roi_cutting_for_ocr.py)
Написан код [label_extraction.py](src/label_extraction.py) создания пар имя фото/изображённый на нём номер и сохранения его в csv  формате для дальнейшего использования в качестве разметки при обучении.
