...
Разметка для модели детектирования осуществлялась в CVAT. Размечено 200 фотографий с применением bounding box. Рамка располагалась максимально близко к границам табло. Выделялось табло целиком с пустыми разрядами и указателем на север. 
