...
## Выбор порогоа уверенности переименования
Произведён запуск скрипта целиком на папке с изображениями тестовой выборки. 
...
Порог общей уверенности распознавания при котором происходит отметка переименования как ненадёжного (!_ перед новым именем) выбран 0.8.
