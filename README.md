...
Даже при высоком значении порога уверенности не удаётся достичь 100% точности переименования. Рекомендуется использовать созданный функционал автопереименования как вспомогательный для уменьшения времени ручного переименования с последующей валидацией.
